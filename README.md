The goal of this project was to create a website that looks similar to an app in functionality, and loads news stories using the New York Times API into the window.
